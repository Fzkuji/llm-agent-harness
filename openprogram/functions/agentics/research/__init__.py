...
from openprogram.functions.agentics.research.pipeline import research_pipeline, STAGES
from openprogram.functions.agentics.research.evaluate import compete
